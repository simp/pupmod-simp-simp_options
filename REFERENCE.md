...
* [`simp_options::gid`](#simp_optionsgid): Sets up system-wide defaults for GID settings
...
* [`simp_options::openssl::params`](#simp_optionsopensslparams): Sets appropriate openssl cipher suite based on whether
...
* [`simp_options::rsync`](#simp_optionsrsync): Sets up SIMP-specific rsync configuration variables
...
Sets up system-wide defaults for GID settings
...
Sets up SIMP-specific rsync configuration variables
...
Sets up system-wide defaults for UID settings
